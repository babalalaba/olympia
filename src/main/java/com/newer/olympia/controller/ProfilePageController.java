...
public class ProfilePageController {
    ...
    public ResponseEntity<?> selectCommentAllByid(@Param("User_id")int User_id,@Param("Blogs_id")int Blogs_id){
        List<Comment> blogs = profilePageService.selectCommentAllByid(User_id,Blogs_id);
