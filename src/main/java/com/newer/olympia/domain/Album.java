...
public class Album implements Serializable {
    ...
    public Album(Integer album_id, String album_name, Integer picture_id, Integer user_id, String album_describe, Integer album_like, List<User> user, List<Picture> picture) {
        Album_id = album_id;
