...
public class FriendComment implements Serializable {
    ...
    public FriendComment(Integer comment_id, Integer comment_user_id, Integer blogs_id, String comment_content, Date comment_time, Integer user_id, String comment_user_name, String comment_user_img) {
